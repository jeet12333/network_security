...
import pandas as pd
import os,sys
from networksecurity.utils.main_utils.utils import read_yaml_file,wite_yaml_file
...
class datavalidation:
    ...
    def detect_dataset_drift(self,base_df,current_df,thresold=0.05)->bool:
        try:
            ...
            wite_yaml_file(file_path=drift_report_file_path,content=report)      
        except Exception as e:
            raise NetworkSecurityException(e,sys)    
    ...
    def initiate_data_validation(self)->DataValidationArtifact:
        try:
            ...
            return data_validation_artifat
        except Exception as e:
            raise NetworkSecurityException(e,sys)
